...
<div class="container" style="margin-top: 50px; width: 450px;">
    <div class="card">
        <img src="https://th.bing.com/th/id/OIP.48_LY_4x25U98zvj5qDNiwHaHV?rs=1&pid=ImgDetMain" style="height: 150px; width: 150px; margin-left: 130px" class="card-img-top"
            alt="...">
        <div class="card-body">
